...
```tsx
<div className="space-y-6">{/* Tout défile ensemble */}</div>
```
...
<div className="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm">
  ...
  <h1>Collections</h1>
  <p>
    {collections.length} collections • {actives} actives
  </p>
</div>
```
...
--primary: #000000 /* Noir signature */ --secondary: #ffffff /* Blanc pur */
  --accent: #666666 /* Gris élégant */ /* Exceptions acceptées */
  --error: #ef4444 /* Rouge erreur (informatif) */ --success: #10b981
  /* Vert succès (informatif) */;
```

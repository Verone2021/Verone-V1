...
- [ ] 65 fichiers `src/lib/` migrés vers packages @verone
...
✓ src/app/canaux-vente/page.tsx (12 changes)
✓ src/app/produits/catalogue/page.tsx (8 changes)
...
...
Files to include: src/app/**/*.tsx, src/components/**/*.tsx
```

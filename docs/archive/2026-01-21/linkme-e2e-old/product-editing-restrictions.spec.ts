...
test.describe('Product Editing Restrictions', () => {
  ...
  test('3.1: Edit product in draft status allows name/description/photos', async ({
    page,
  }) => {
  ...
  test('3.2: Cannot change store_at_verone after product creation', async ({
    page,
  }) => {
  ...
  test('3.3: Product in pending_approval is read-only', async ({ page }) => {
    ...
    await updateProductApprovalStatus(productId, 'pending_approval');
  ...
  test('3.4: Product in approved status is read-only', async ({ page }) => {
    ...
    await updateProductApprovalStatus(productId, 'approved', {
      commissionRate: 15,
    });
  ...
  test('3.5: Product in rejected status can be edited and resubmitted', async ({
    page,
  }) => {
    ...
    await updateProductApprovalStatus(productId, 'rejected', {
  ...
  test('3.6: Affiliate cannot modify commission_rate', async ({ page }) => {

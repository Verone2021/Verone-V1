...
| [WORKFLOWS-CRITIQUES.md](./WORKFLOWS-CRITIQUES.md)                               | 5 workflows critiques + 3 secondaires, mapping tests E2E | Tests E2E & QA       |
...
| [security/api-routes-guards.md](./security/api-routes-guards.md) | Trousseau des routes API : quelle porte, quelle serrure |

  ...
  public: {
    Tables: {
      ...
      financial_document_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "financial_document_items_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "financial_documents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "financial_document_items_linkme_selection_item_id_fkey"
          ...
          {
            foreignKeyName: "financial_document_items_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product_prices_summary"
            referencedColumns: ["product_id"]
      ...
      financial_documents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "financial_documents_linkme_affiliate_id_fkey"
            columns: ["linkme_affiliate_id"]
            isOneToOne: false
            referencedRelation: "linkme_affiliates"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "financial_documents_linkme_selection_id_fkey"
      ...
      meta_commerce_syncs: {
        ...
        Relationships: [
          {
            foreignKeyName: "meta_commerce_syncs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: true
            referencedRelation: "product_prices_summary"
            referencedColumns: ["product_id"]
      ...
      organisation_families: {
        ...
        Relationships: [
          {
            foreignKeyName: "organisation_families_family_id_fkey"
            columns: ["family_id"]
            isOneToOne: false
            referencedRelation: "families"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "organisation_families_organisation_id_fkey"
            columns: ["organisation_id"]
            isOneToOne: false
            referencedRelation: "organisations"
            referencedColumns: ["id"]
      ...
      organisations: {
        Row: {
          ...
          supplier_segment:
            ...
            | null
          supplier_specialties: string[] | null
          supplier_timezone: string | null
          trade_name: string | null
      ...
      products: {
        Row: {
          ...
          sourcing_priority: string | null
          sourcing_status: string | null
          sourcing_tags: string[] | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "products_consultation_id_fkey"
            columns: ["consultation_id"]
            isOneToOne: false
            referencedRelation: "client_consultations"
            referencedColumns: ["id"]
      ...
      sourcing_candidate_suppliers: {
        ...
        Relationships: [
          {
            foreignKeyName: "sourcing_candidate_suppliers_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product_prices_summary"
            referencedColumns: ["product_id"]
          ...
          {
            foreignKeyName: "sourcing_candidate_suppliers_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "organisations"
            referencedColumns: ["id"]
      ...
      sourcing_communications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sourcing_communications_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "organisations"
            referencedColumns: ["id"]
      ...
      sourcing_price_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "sourcing_price_history_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product_prices_summary"
            referencedColumns: ["product_id"]
          ...
          {
            foreignKeyName: "sourcing_price_history_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "organisations"
            referencedColumns: ["id"]
      ...
      sourcing_urls: {
        ...
        Relationships: [
          {
            foreignKeyName: "sourcing_urls_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product_prices_summary"
            referencedColumns: ["product_id"]
    ...
    Functions: {
      ...
      approve_storage_request: { Args: { p_request_id: string }; Returns: Json }
      ...
      batch_add_meta_commerce_products: {
        Args: { p_catalog_id?: string; p_product_ids: string[] }
        Returns: {
          error_count: number
      ...
      delete_order_payment: { Args: { p_payment_id: string }; Returns: boolean }
      ...
      get_affiliate_storage_summary: {
        Args: { p_owner_enseigne_id?: string; p_owner_organisation_id?: string }
        Returns: {
      ...
      get_next_variant_position: { Args: { group_id: string }; Returns: number }
      ...
      mark_warehouse_exit:
        ...
        | { Args: { p_order_id: string; p_user_id?: string }; Returns: boolean }
      ...
      toggle_meta_commerce_visibility: {
        Args: { p_product_id: string; p_visible: boolean }
        Returns: undefined
      }
      ...
      update_meta_sync_status: {
        Args: {
          ...
          p_meta_status: string
          p_sync_id: string
        }
        Returns: undefined
      }
      update_product_pmp_on_po_received: {
        Args: { p_po_id: string }
        Returns: undefined
      }
      update_test_status: {

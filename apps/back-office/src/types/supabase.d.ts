    ...
    public: {
        Tables: {
            ...
            _backup_products_20251223: {
                Row: {
                    affiliate_approval_status: Database['public']['Enums']['affiliate_product_approval_status'] | null;
                    ...
                    availability_type: Database['public']['Enums']['availability_type_enum'] | null;
                    brand: string | null;
                    ...
                    name: string | null;
                    product_status: Database['public']['Enums']['product_status_type'] | null;
            ...
            expenses_backup: {
                ...
                Relationships: [
                    ...
                    {
                        foreignKeyName: 'expenses_pcg_code_fkey';
                        columns: ['pcg_code'];
                        isOneToOne: false;
                        referencedRelation: 'pcg_categories';
                    ...
                    },
                    {
                        ...
                        columns: ['pcg_code'];
                        isOneToOne: false;
                        referencedRelation: 'v_pcg_categories_tree';
                        referencedColumns: ['code'];
                    },
                    {
            ...
            feed_configs: {
                Row: {
                    ...
                    schedule_frequency: Database['public']['Enums']['schedule_frequency_type'] | null;
            ...
            individual_customers: {
                Row: {
                    ...
                    source_type: Database['public']['Enums']['customer_source_type'] | null;
                    updated_at: string | null;
                };
                Insert: {
                    abby_contact_id?: string | null;
            ...
            organisations: {
                Row: {
                    ...
                    notes: string | null;
                    ownership_type: Database['public']['Enums']['organisation_ownership_type'] | null;
                    ...
                    source_affiliate_id: string | null;
                    source_type: Database['public']['Enums']['customer_source_type'] | null;
                    supplier_segment: Database['public']['Enums']['supplier_segment_type'] | null;
            ...
            organisations_backup_20251227: {
                Row: {
                    ...
                    industry_sector: string | null;
                    is_active: boolean | null;
                    is_enseigne_parent: boolean | null;
                    is_service_provider: boolean | null;
                    legal_form: string | null;
            ...
            purchase_orders: {
                Row: {
                    ...
                    manual_payment_type: Database['public']['Enums']['manual_payment_type'] | null;
                    notes: string | null;
        ...
        Views: {
            ...
            expenses: {
                Row: {
                    ...
                    id: string | null;
                    label: string | null;
                    matching_status: Database['public']['Enums']['matching_status'] | null;
                    notes: string | null;
                    organisation_id: string | null;
                    raw_data: Json | null;
                    role_type: string | null;
            ...
            v_expenses_with_details: {
                Row: {
                    ...
                    organisation_type: Database['public']['Enums']['organisation_type'] | null;
                    raw_data: Json | null;
                    role_type: string | null;
            ...
            v_matching_rules_with_org: {
                Row: {
                    allow_multiple_categories: boolean | null;
                    applies_to_side: Database['public']['Enums']['transaction_side_filter'] | null;
            ...
            v_transaction_documents: {
                Row: {
                    ...
                    purchase_order_status: Database['public']['Enums']['purchase_order_status'] | null;
                    sales_order_amount: number | null;
                    sales_order_id: string | null;
                    sales_order_number: string | null;
                    sales_order_status: Database['public']['Enums']['sales_order_status'] | null;
                    transaction_amount: number | null;
                    transaction_date: string | null;
                    transaction_id: string | null;
                    transaction_label: string | null;
                    transaction_side: Database['public']['Enums']['transaction_side'] | null;
                };
                Relationships: [
                    {
                        foreignKeyName: 'transaction_document_links_document_id_fkey';
            ...
            v_transactions_unified: {
                Row: {
                    ...
                    matched_document_type: Database['public']['Enums']['document_type'] | null;
                    matching_status: Database['public']['Enums']['matching_status'] | null;
                    month: number | null;
                    nature: string | null;
                    operation_type: string | null;
        ...
        Functions: {
            ...
            apply_matching_rule_confirm: {
                Args: {
                    p_rule_id: string;
                    p_selected_normalized_labels: string[];
                };
                Returns: {
                    nb_updated: number;
                    updated_ids: string[];
            ...
            get_enseigne_details: {
                Args: {
                    enseigne_uuid: string;
                };
                Returns: Json;
            };
            ...
            get_stock_reason_description: {
                Args: {
                    reason: Database['public']['Enums']['stock_reason_code'];
                };
                Returns: string;
            };
            get_stock_summary: {
            ...
            is_enseigne_admin: {
                Args: {
                    check_enseigne_id: string;
                };
                Returns: boolean;
            };
            is_enseigne_admin_for: {
                Args: {
                    target_enseigne_id: string;
                };
                Returns: boolean;
            };
            is_owner: {
        ...
        Enums: {
            affiliate_product_approval_status: 'draft' | 'pending_approval' | 'approved' | 'rejected';
            ...
            document_status: 'draft' | 'sent' | 'received' | 'paid' | 'partially_paid' | 'overdue' | 'cancelled' | 'refunded';
            document_type: 'customer_invoice' | 'customer_credit_note' | 'supplier_invoice' | 'supplier_credit_note' | 'expense';
            error_severity_enum: 'critical' | 'high' | 'medium' | 'low';
            error_status_enum: 'open' | 'in_progress' | 'resolved' | 'closed';
            error_type_enum: 'javascript_error' | 'network_error' | 'ui_bug' | 'performance_issue' | 'console_error' | 'data_validation' | 'functional_bug';
            feed_export_status_type: 'pending' | 'processing' | 'completed' | 'failed' | 'cancelled';
            feed_format_type: 'csv' | 'xml' | 'json';
            feed_platform_type: 'google_merchant' | 'facebook_meta' | 'custom';
            image_type_enum: 'primary' | 'gallery' | 'technical' | 'lifestyle' | 'thumbnail';
            language_type: 'fr' | 'en' | 'pt';
            manual_payment_type: 'cash' | 'check' | 'transfer_other' | 'card' | 'compensation' | 'verified_bubble';
            matching_status: 'unmatched' | 'auto_matched' | 'manual_matched' | 'partial_matched' | 'ignored';
            ...
            payment_terms_type: 'IMMEDIATE' | 'NET_15' | 'NET_30' | 'NET_45' | 'NET_60' | 'NET_90' | 'CUSTOM';
            product_status_type: 'active' | 'preorder' | 'discontinued' | 'draft';
            purchase_order_status: 'draft' | 'validated' | 'partially_received' | 'received' | 'cancelled';
            purchase_type: 'dropshipping' | 'stock' | 'on_demand';
            room_type: 'salon' | 'salle_a_manger' | 'chambre' | 'bureau' | 'bibliotheque' | 'salon_sejour' | 'cuisine' | 'salle_de_bain' | 'wc' | 'toilettes' | 'hall_entree' | 'couloir' | 'cellier' | 'buanderie' | 'dressing' | 'cave' | 'grenier' | 'garage' | 'terrasse' | 'balcon' | 'jardin' | 'veranda' | 'loggia' | 'cour' | 'patio' | 'salle_de_jeux' | 'salle_de_sport' | 'atelier' | 'mezzanine' | 'sous_sol';
            sales_order_status: 'draft' | 'validated' | 'partially_shipped' | 'shipped' | 'delivered' | 'cancelled';
            sample_request_status_type: 'pending_approval' | 'approved' | 'rejected';
            sample_status_type: 'not_required' | 'request_pending' | 'request_approved' | 'ordered' | 'delivered' | 'approved' | 'rejected';
            schedule_frequency_type: 'manual' | 'daily' | 'weekly' | 'monthly';
            season_type: 'spring' | 'summer' | 'autumn' | 'winter' | 'all_year';
            sourcing_status_type: 'draft' | 'sourcing_validated' | 'ready_for_catalog' | 'archived';
            stock_reason_code: 'sale' | 'transfer_out' | 'damage_transport' | 'damage_handling' | 'damage_storage' | 'theft' | 'loss_unknown' | 'sample_client' | 'sample_showroom' | 'marketing_event' | 'photography' | 'rd_testing' | 'prototype' | 'quality_control' | 'return_supplier' | 'return_customer' | 'warranty_replacement' | 'inventory_correction' | 'write_off' | 'obsolete' | 'purchase_reception' | 'return_from_client' | 'found_inventory' | 'manual_adjustment' | 'cancelled';
            stock_status_type: 'in_stock' | 'out_of_stock' | 'coming_soon';
            supplier_segment_type: 'strategic' | 'preferred' | 'approved' | 'commodity' | 'artisan' | 'goods_supplier' | 'service_provider' | 'logistics' | 'government';
            sync_run_status: 'pending' | 'running' | 'completed' | 'partial' | 'failed' | 'cancelled';
            sync_type: 'transactions' | 'client_invoices' | 'attachments' | 'labels' | 'full';
            test_status_enum: 'pending' | 'passed' | 'failed' | 'warning';
            transaction_side: 'credit' | 'debit';
            transaction_side_filter: 'debit' | 'credit' | 'both';
            user_role_type: 'owner' | 'admin' | 'catalog_manager' | 'sales' | 'partner_manager' | 'customer';
...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly affiliate_product_approval_status: readonly ["draft", "pending_approval", "approved", "rejected"];
            readonly app_type: readonly ["back-office", "site-internet", "linkme"];
            readonly article_type: readonly ["vente_de_marchandises", "prestations_de_services"];
            readonly availability_type_enum: readonly ["normal", "preorder", "coming_soon", "discontinued"];
            readonly bank_provider: readonly ["qonto", "revolut"];
            readonly client_type: readonly ["particulier", "professionnel"];
            readonly customer_source_type: readonly ["internal", "linkme", "site-internet", "manual"];
            readonly document_direction: readonly ["inbound", "outbound"];
            readonly document_status: readonly ["draft", "sent", "received", "paid", "partially_paid", "overdue", "cancelled", "refunded"];
            readonly document_type: readonly ["customer_invoice", "customer_credit_note", "supplier_invoice", "supplier_credit_note", "expense"];
            readonly error_severity_enum: readonly ["critical", "high", "medium", "low"];
            readonly error_status_enum: readonly ["open", "in_progress", "resolved", "closed"];
            readonly error_type_enum: readonly ["javascript_error", "network_error", "ui_bug", "performance_issue", "console_error", "data_validation", "functional_bug"];
            readonly feed_export_status_type: readonly ["pending", "processing", "completed", "failed", "cancelled"];
            readonly feed_format_type: readonly ["csv", "xml", "json"];
            readonly feed_platform_type: readonly ["google_merchant", "facebook_meta", "custom"];
            readonly image_type_enum: readonly ["primary", "gallery", "technical", "lifestyle", "thumbnail"];
            readonly language_type: readonly ["fr", "en", "pt"];
            readonly manual_payment_type: readonly ["cash", "check", "transfer_other", "card", "compensation", "verified_bubble"];
            readonly matching_status: readonly ["unmatched", "auto_matched", "manual_matched", "partial_matched", "ignored"];
            readonly movement_type: readonly ["IN", "OUT", "ADJUST", "TRANSFER"];
            readonly organisation_type: readonly ["internal", "supplier", "customer", "partner"];
            readonly package_type: readonly ["single", "pack", "bulk", "custom"];
            readonly payment_terms_type: readonly ["IMMEDIATE", "NET_15", "NET_30", "NET_45", "NET_60", "NET_90", "CUSTOM"];
            readonly product_status_type: readonly ["active", "preorder", "discontinued", "draft"];
            readonly purchase_order_status: readonly ["draft", "validated", "partially_received", "received", "cancelled"];
            readonly purchase_type: readonly ["dropshipping", "stock", "on_demand"];
            readonly room_type: readonly ["salon", "salle_a_manger", "chambre", "bureau", "bibliotheque", "salon_sejour", "cuisine", "salle_de_bain", "wc", "toilettes", "hall_entree", "couloir", "cellier", "buanderie", "dressing", "cave", "grenier", "garage", "terrasse", "balcon", "jardin", "veranda", "loggia", "cour", "patio", "salle_de_jeux", "salle_de_sport", "atelier", "mezzanine", "sous_sol"];
            readonly sales_order_status: readonly ["draft", "validated", "partially_shipped", "shipped", "delivered", "cancelled"];
            readonly sample_request_status_type: readonly ["pending_approval", "approved", "rejected"];
            readonly sample_status_type: readonly ["not_required", "request_pending", "request_approved", "ordered", "delivered", "approved", "rejected"];
            readonly schedule_frequency_type: readonly ["manual", "daily", "weekly", "monthly"];
            readonly season_type: readonly ["spring", "summer", "autumn", "winter", "all_year"];
            readonly sourcing_status_type: readonly ["draft", "sourcing_validated", "ready_for_catalog", "archived"];
            readonly stock_reason_code: readonly ["sale", "transfer_out", "damage_transport", "damage_handling", "damage_storage", "theft", "loss_unknown", "sample_client", "sample_showroom", "marketing_event", "photography", "rd_testing", "prototype", "quality_control", "return_supplier", "return_customer", "warranty_replacement", "inventory_correction", "write_off", "obsolete", "purchase_reception", "return_from_client", "found_inventory", "manual_adjustment", "cancelled"];
            readonly stock_status_type: readonly ["in_stock", "out_of_stock", "coming_soon"];
            readonly supplier_segment_type: readonly ["strategic", "preferred", "approved", "commodity", "artisan", "goods_supplier", "service_provider", "logistics", "government"];
            readonly sync_run_status: readonly ["pending", "running", "completed", "partial", "failed", "cancelled"];
            readonly sync_type: readonly ["transactions", "client_invoices", "attachments", "labels", "full"];
            readonly test_status_enum: readonly ["pending", "passed", "failed", "warning"];
            readonly transaction_side: readonly ["credit", "debit"];
            readonly transaction_side_filter: readonly ["debit", "credit", "both"];
            readonly user_role_type: readonly ["owner", "admin", "catalog_manager", "sales", "partner_manager", "customer"];
            readonly user_type: readonly ["staff", "supplier", "customer", "partner"];
        };
    };
};
export {};

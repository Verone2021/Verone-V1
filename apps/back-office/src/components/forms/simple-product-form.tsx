...
export function SimpleProductForm({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // Note: sku is auto-generated by DB trigger (BEFORE INSERT)
      type ProductInsert = Database['public']['Tables']['products']['Insert'];
      const productData: Omit<ProductInsert, 'sku'> & { sku?: string } = {
        name: formData.name.trim(),
        supplier_page_url: formData.supplier_page_url.trim(),
        stock_status: 'in_stock',
        product_type: 'standard',
        creation_mode: 'complete',
        // Required field with default (will be set later from product detail page)
        cost_price: 0.01,
      };

...
export function SimpleProductForm({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // Note: sku is auto-generated by DB trigger, type assertion required
      const { data: newProduct, error: productError } = await supabase
        .from('products')
        // eslint-disable-next-line @typescript-eslint/no-explicit-any -- sku is auto-generated by DB trigger

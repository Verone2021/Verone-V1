                ...
                <TabsContent value="images" className="space-y-6">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <Label>
                        Images produit ({catalogueImages.length})
                        {imagesLoading && (
                      ...
                      <div className="grid grid-cols-4 gap-4">
                        {catalogueImages.map((img, i) => (
                          <button
                            ...
                            className="relative group border rounded-lg overflow-hidden hover:border-black hover:shadow-lg transition-all cursor-pointer"
                          >
                            <ProductThumbnail
                              src={img.public_url}
                  ...
                  {product.has_variants ? (
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Les variantes de ce produit sont gérées dans la fiche
                        produit principale.
                      </p>
                    </div>
                  ) : (
                    <div className="text-center py-12 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-gray-600">Aucune variante</p>
                      <p className="text-sm text-gray-500 mt-1">

...
/**
 * Table / list rows for echantillons (active + archived).
 */
...
// ---------------------------------------------------------------------------
// SampleInfoGrid (shared between active and archived rows)
// ---------------------------------------------------------------------------
    ...
    <Card className="border-black">
      <CardHeader>
        <CardTitle className="text-black">
          Échantillons Actifs ({samples.length})
        </CardTitle>
...
export function ArchivedSamplesTab({
  ...
  return (
    <Card className="border-black">
      <CardHeader>
        <CardTitle className="text-black">
          Échantillons Archivés ({samples.length})
        </CardTitle>

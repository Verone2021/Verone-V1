...
export default function LinkMeCataloguePage() {
  ...
  // State: Modal ajout produits (étape 1: sélection, étape 2: configuration prix)
  ...
  // Étape 1: L'utilisateur sélectionne des produits → on ouvre le dialog prix
  const handleProductsSelected = useCallback((products: SelectedProduct[]) => {
    if (products.length === 0) return;

    setPendingProducts(products);
    // Initialiser la config prix pour chaque produit
  ...
  // Vérifie si tous les prix sont valides (> 0)
  ...
  // Étape 2: L'utilisateur confirme les prix → on insère
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Modal Ajout Produits - Étape 1: Sélection */}
      <UniversalProductSelectorV2
        open={isAddModalOpen}
      ...
      {/* Modal Configuration Prix - Étape 2 */}
      <Dialog
        ...
        <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          placeholder="0"
                          value={
                            pricingConfig[product.id]?.commissionRate ?? '0'
                          }
                          onChange={e =>
                            setPricingConfig(prev => ({
                              ...prev,
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <ButtonV2
              ...
              onClick={() => {
                void handleConfirmAddProducts().catch((error: unknown) => {
                  console.error(
                    '[LinkMeCatalogue] Add products failed:',
                    error
                  );
                });
              }}

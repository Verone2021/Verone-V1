...
import { Badge, Button, Label } from '@verone/ui';
import {
  AlertTriangle,
  Calendar,
  Check,
...
export function OrgAddressButton({
  org,
  ...
  return (
    <button
      ...
      className={`w-full text-left p-3 rounded-lg border transition-colors ${deliveryAddressMatchesOrg ? 'bg-blue-50 border-blue-100 cursor-default' : 'bg-blue-50 border-blue-200 cursor-pointer hover:bg-blue-100 hover:border-blue-300'}`}
      onClick={() => {
    ...
    <div className="space-y-3">
      ...
      {details.delivery_address ? (
        <div>
          ...
          {org && (
            <span
              className={`inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded text-xs font-medium ${deliveryAddressMatchesOrg ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'}`}
            >
              {deliveryAddressMatchesOrg ? (
                <>
          ...
          <div className="flex items-center justify-between">
            ...
            {details.access_form_url && (
              <a
                ...
                className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded bg-blue-100 text-blue-700 hover:bg-blue-200"
              >

  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const baseQuery = supabase
        .from('addresses')
        .select(
          'id, owner_type, owner_id, address_type, label, legal_name, trade_name, siret, vat_number, address_line1, address_line2, postal_code, city, region, country, is_default'
        )

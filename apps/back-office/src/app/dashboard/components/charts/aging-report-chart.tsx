...
/**
 * Graphique: Vieillissement créances
 * Répartition des créances par ancienneté
 *
 * @created 2026-01-12
 * @todo Intégrer avec hook useAgingReport quand format données adapté
 */
...
export function AgingReportChart({ onRemove }: AgingReportChartProps) {
  // TODO: Le hook useAgingReport retourne un format différent - adapter
  return (
      ...
      <CardContent className="flex-1 pt-0">
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Format données useAgingReport à adapter
          </p>
        </div>
      </CardContent>
    </Card>

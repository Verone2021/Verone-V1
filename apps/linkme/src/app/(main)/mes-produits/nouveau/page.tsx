...
import { Package, Loader2, ArrowLeft, Euro, ImagePlus } from 'lucide-react';
...
import { ProductStorageSection } from './components/ProductStorageSection';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="relative max-w-xs">
                  <input
                    ...
                    step="0.01"
                    min="0"
                    className={`w-full px-4 py-2.5 pr-12 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.affiliate_payout_ht ? 'border-red-500' : 'border-gray-300'}`}
                    placeholder="100.00"
                  />
          ...
          <div className="lg:col-span-1">
            <ProductPreviewSidebar
              payout={payout}
              storeAtVerone={formData.store_at_verone}
              ...
              onSubmitForApproval={() => {
                void handleSubmitForApproval().catch(error => {
                  console.error('[NouveauProduitPage] Submit failed:', error);
                  const errorMessage =
                    error instanceof Error
                      ? error.message
                      : 'Erreur lors de la soumission pour approbation';

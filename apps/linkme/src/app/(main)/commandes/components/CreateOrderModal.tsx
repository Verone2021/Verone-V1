  ...
  if (!isNewRestaurant) {
    return (
      <>
                                        ...
                                        <div className="flex-1 min-w-0">
                                          ...
                                          <div className="flex items-center gap-2 mt-2">
                                            <span className="text-sm font-semibold text-gray-900">
                                              {product.sellingPriceHt.toFixed(
                                                2
                                              )}{' '}
                                              €
                                            </span>
        ...
        {/* Modal de confirmation commande restaurant existant */}
        {showConfirmExistingModal && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            <div
              className="absolute inset-0 bg-black/60 backdrop-blur-sm"
              onClick={() => setShowConfirmExistingModal(false)}
            />
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <p className="text-gray-600">
                  Vous etes sur le point de soumettre une commande pour :
                </p>
                <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                  <p className="font-semibold text-gray-900">
                    {_selectedCustomer?.name ?? 'Restaurant selectionne'}
                  </p>
                ...
                <div className="flex items-start gap-2 text-sm text-amber-700 bg-amber-50 p-3 rounded-lg">
                  ...
                  <p>
                    La commande sera envoyee a l&apos;equipe pour validation.
                  </p>
                </div>
              </div>

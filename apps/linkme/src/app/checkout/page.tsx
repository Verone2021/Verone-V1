...
import { ArrowLeft, Lock, Package, CreditCard, Truck, User, AlertCircle } from 'lucide-react';
...
declare global {
  interface Window {
    RevolutCheckout?: (token: string, mode: 'sandbox' | 'prod') => Promise<RevolutCheckoutInstance>;
  }
}
...
export default function CheckoutPage() {
  ...
  const updateFormData = useCallback((field: keyof CheckoutFormData, value: string | boolean) => {
    setFormData(prev => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.firstName || !formData.lastName || !formData.address || !formData.postalCode || !formData.city) {
      setPaymentError('Veuillez remplir votre adresse de livraison');
      return false;
    }
    if (!formData.useSameForBilling) {
      if (!formData.billingFirstName || !formData.billingLastName || !formData.billingAddress || !formData.billingPostalCode || !formData.billingCity) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!revolutLoaded || !window.RevolutCheckout) {
      setPaymentError('Le module de paiement n\'est pas encore chargé. Veuillez réessayer.');
      return;
    }
    ...
    try {
      ...
      const mode = process.env.NEXT_PUBLIC_REVOLUT_ENVIRONMENT === 'prod' ? 'prod' : 'sandbox';
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mt-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => updateFormData('useSameForBilling', e.target.checked)}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) => updateFormData('billingAddressComplement', e.target.value)}
                        className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      />
                    </div>
                    <div>
              ...
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-blue-900">Paiement par carte bancaire</p>
              ...
              <p className="text-xs text-gray-500 text-center">
                ...
                Le paiement est sécurisé par Revolut.
              </p>
            </form>
          </div>

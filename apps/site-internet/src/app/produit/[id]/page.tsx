      ...
      <div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Description détaillée du produit. Dimensions, matériaux, caractéristiques...
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="number" defaultValue="1" min="1" className="border rounded-lg px-4 py-2 w-24" />
          </div>

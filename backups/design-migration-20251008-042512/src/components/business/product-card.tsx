                ...
                <div className="flex items-center gap-1">
                  ...
                  {(() => {
                    ...
                    return discountLabel ? (
                      <Badge variant="secondary" className="text-[9px] bg-orange-50 text-orange-700 border-orange-200 px-1 py-0">
                        {discountLabel}
                      </Badge>
                    ) : null
                  })()}
            ...
            <div className="flex gap-1">
              ...
              {onArchive && (
                <Button
                  ...
                  className={`flex-1 min-w-0 h-6 text-[10px] px-1.5 ${archived ? "text-blue-600 border-blue-200 hover:bg-blue-50" : "text-orange-600 border-orange-200 hover:bg-orange-50"}`}
                >
                  {archived ? (
                    <>

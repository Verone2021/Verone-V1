...
test.describe('Page Mouvements - Stock Réel Uniquement', () => {
  ...
  test("n'affiche AUCUN onglet Réel/Prévisionnel imbriqué", async ({
    page,
  }) => {
  ...
  test('affiche uniquement des mouvements réels (pas de badge "Prévisionnel ↗/↘")', async ({
    page,
  }) => {
  ...
  test('affiche le filtre actif "affects_forecast" dans le badge Filtres', async ({
    page,
  }) => {
    // Le badge "Filtres" doit afficher "1" (filtre affects_forecast actif)
    const filtersBadge = page
  ...
  test('onglet Entrées affiche badge "Stock Réel Uniquement"', async ({
    page,
  }) => {
  ...
  test('onglet Sorties affiche badge "Stock Réel Uniquement"', async ({
    page,
  }) => {

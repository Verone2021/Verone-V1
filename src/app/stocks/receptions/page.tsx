...
/**
 * 📦 Page Réceptions Achats (Purchase Orders)
 *
...
export default function ReceptionsPage() {
  ...
  }, [loadPurchaseOrdersReadyForReception, statusFilter, searchTerm, urgencyFilter])
  ...
  return (
    <div className="space-y-6 p-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Réceptions Marchandises</h1>
        <p className="text-gray-600 mt-1">Gestion des réceptions fournisseurs</p>
      </div>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">Aucune commande à réceptionner</p>
            </div>
          ) : (
              ...
              <Table>
                ...
                <TableBody>
                  {orders.map((order) => {
                    ...
                    const totalItems = order.purchase_order_items?.reduce(
                      (sum: number, item: any) => sum + item.quantity,
                      0
                    ) || 0
                    const receivedItems = order.purchase_order_items?.reduce(

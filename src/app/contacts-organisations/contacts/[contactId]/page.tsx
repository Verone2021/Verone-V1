        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Ce contact n'existe pas ou vous n'avez pas les droits pour le
              consulter.
            </p>
          ...
          <div className="flex items-center gap-2 text-gray-600">
            ...
            <span>
              {currentContact.organisation &&
                getOrganisationDisplayName(
                  currentContact.organisation as Organisation
                )}{' '}
              •{' '}
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-black">
                    {getOrganisationTypeLabel(currentContact.organisation.type)}
                  </div>
                </div>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              {currentContact.last_contact_date && (
                <div className="flex justify-between">
                  ...
                  <span className="text-black">
                    {formatDate(currentContact.last_contact_date)}
                  </span>
                </div>
              )}
              <div className="flex justify-between">
                ...
                <Badge
                  variant={currentContact.is_active ? 'secondary' : 'secondary'}
                  className={
                    currentContact.is_active

    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-slate-900">Organisations & Contacts</h1>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <ElegantKpiCard
              ...
              icon={Truck}
              onClick={() => router.push('/organisation/all?tab=suppliers')}
            />
            ...
            <ElegantKpiCard
              ...
              icon={Building2}
              onClick={() => router.push('/organisation/all?tab=customers')}
            />
            ...
            <ElegantKpiCard
              ...
              icon={Settings}
              onClick={() => router.push('/organisation/all?tab=partners')}
            />
          </div>
        </div>

  ...
  return (
    <div className={cn('flex flex-wrap items-center gap-1', className)}>
      {displayCategories.map((cat) => (
        <SingleCategoryBadge key={cat} categoryCode={cat} size={size} showIcon={showIcon} />
      ))}
      {remainingCount > 0 && (
        <span
          className={cn(
 ...
 */
export function parseCategoriesString(categoryString: string | null | undefined): SupplierCategoryCode[] {
 ...
 */
export function getCategoryLabel(categoryCode: SupplierCategoryCode | string): string {

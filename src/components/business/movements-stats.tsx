      ...
      <Card className="border-black rounded-[10px] shadow-md">
        ...
        <CardContent>
          <div className="flex items-center justify-around gap-4">
            ...
            <div className="flex items-center gap-2">
              <Badge variant="primary" className="bg-blue-100 text-blue-800 hover:bg-blue-100">
                Ajustements
              </Badge>
              <span className="font-medium text-black">{formatNumber(stats.byType.ADJUST)}</span>
            </div>
            <div className="flex items-center gap-2">
              <Badge variant="primary" className="bg-purple-100 text-purple-800 hover:bg-purple-100">
                Transferts
              </Badge>

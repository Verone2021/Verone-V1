...
export function VariantGroupEditModal({
  ...
  useEffect(() => {
    if (group && isOpen) {
      ...
      // Dimensions communes
      if (group.common_dimensions) {
        setDimensionsLength(group.common_dimensions.length)
        setDimensionsWidth(group.common_dimensions.width)
        setDimensionsHeight(group.common_dimensions.height)
        setDimensionsUnit(group.common_dimensions.unit || 'cm')
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const commonDimensions = (dimensionsLength && dimensionsWidth && dimensionsHeight) ? {

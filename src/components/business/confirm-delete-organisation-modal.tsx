        ...
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {organisation.email && (
                <p className="text-xs text-gray-600 mt-1">{organisation.email}</p>
              )}
              {organisation.phone && (
                <p className="text-xs text-gray-600">{organisation.phone}</p>
              )}
              {organisation.city && (
                <p className="text-xs text-gray-500 mt-1">{organisation.city}</p>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <ul className="text-xs text-red-700 space-y-1 list-disc list-inside">
                <li>Les informations de {getTypeLabel()} seront définitivement supprimées</li>

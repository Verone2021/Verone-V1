...
export function RelationsEditSection({
  product,
  onUpdate,
  className,
}: RelationsEditSectionProps) {
  ...
  const renderHierarchy = (group: ProductGroup) => {
    ...
    return (
      <div className="text-xs text-blue-600 mt-1">
        {group.subcategories.categories.families.name} ›{' '}
        {group.subcategories.categories.name} › {group.subcategories.name}
      </div>
    );
  };
              ...
              <div className="flex items-start">
                ...
                <div className="text-sm text-gray-800">
                  <div className="font-medium">
                    Attention: Changement de groupe
                  </div>
                  <div className="mt-1">
                    Changer le groupe de produit peut affecter la catégorisation
                    et les relations avec d'autres variantes.
                  </div>
                </div>
              </div>
            </div>

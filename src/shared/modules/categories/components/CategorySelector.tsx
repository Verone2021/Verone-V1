...
interface CategorySelectorProps {
  ...
  onChange: (subcategoryId: string, hierarchy: {
    family: Family
    category: Category
        ...
        <div className="absolute z-50 mt-1 w-full bg-white border border-gray-300 rounded-md shadow-lg">
          <div className="max-h-80 overflow-y-auto">
            ...
            <div className="p-2 border-b border-gray-200">
              <div className="text-xs font-medium text-gray-500 mb-2">Famille</div>
                ...
                {families.map((family) => (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedFamily?.id === family.id && "bg-black text-white hover:bg-gray-800"
                    )}
                  >
            ...
            {selectedFamily && (
              <div className="p-2 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 mb-2">Catégorie</div>
                <div className="space-y-1">
                  {categories.map((category) => (
                    <button
                      ...
                      className={cn(
                        ...
                        selectedCategory?.id === category.id && "bg-black text-white hover:bg-gray-800"
                      )}
                    >
            ...
            {selectedCategory && (
              <div className="p-2">
                <div className="text-xs font-medium text-gray-500 mb-2">Sous-catégorie</div>
                <div className="space-y-1">
                  {subcategories.map((subcategory) => (
                    <button
                      ...
                      className={cn(
                        ...
                        selectedSubcategory?.id === subcategory.id && "bg-black text-white hover:bg-gray-800"
                      )}
                    >

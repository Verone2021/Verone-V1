...
export function GeneralInfoEditSection({
  product,
  onUpdate,
  className,
}: GeneralInfoEditSectionProps) {
  const {
    isEditing,
    isSaving,
    getError,
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 mt-1">
              Utilisé pour l'URL du produit. Se génère automatiquement depuis le
              nom.
            </div>
          </div>
        </div>
    ...
    <div className={cn('card-verone p-4', className)}>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="text-sm font-mono text-blue-600 bg-blue-50 px-2 py-1 rounded mt-1">
            {product.slug}
          </div>
        </div>
      </div>

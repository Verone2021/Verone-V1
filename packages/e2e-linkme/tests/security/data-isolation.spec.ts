...
test.describe('Data Isolation (RLS)', () => {
  ...
  test('5.1: Enseigne cannot see independent org products', async ({ page, loginLinkMe, loginBackOffice, db }) =>
    page,
  }) => {
  ...
  test('5.2: Independent org cannot see enseigne orders', async ({ page, loginLinkMe, loginBackOffice, db }) => {
    ...
    const orderId = await db.createTestOrder({

...
interface LinkMeSelectionOption {
  id: string;
  name: string;
  products_count?: number | null;
}

export interface LinkMeSelectionStepProps {
  selections: LinkMeSelectionOption[] | undefined;
...
export function LinkMeSelectionStep({
  selections,
  onSelectSelection,
  onBack,
}: LinkMeSelectionStepProps): React.ReactNode {
  return (
    <div className="py-4">
      <div className="mb-4">
        <ButtonV2

  ...
  const fetchFamilies = useCallback(async () => {
    try {
      ...
      const { data, error } = await supabase
        ...
        .select(
          `
          id, name, slug, description, image_url, cloudflare_image_id, is_active, display_order, created_by, meta_title, meta_description, retail_coefficient, wholesale_coefficient, created_at, updated_at,

...
const PREDEFINED_MATERIALS = [
  { value: 'Bois', label: 'Bois', description: 'Matériau naturel' },
  {
    value: 'Métal',
    label: 'Métal',
    description: 'Acier, aluminium, laiton...',
  },
  ...
  { value: 'Tissu', label: 'Tissu', description: 'Textile, velours, lin...' },
  {
    value: 'Céramique',
    label: 'Céramique',
    description: 'Porcelaine, grès...',
  },
  {
    value: 'Verre',
    label: 'Verre',
    description: 'Verre transparent ou coloré',
  },
  {
    value: 'Plastique',
    label: 'Plastique',
    description: 'Plastique recyclé ou non',
  },
  {
    value: 'Pierre',
    label: 'Pierre',
    description: 'Marbre, granit, ardoise...',
  },
  ...
  { value: 'Sisal', label: 'Sisal', description: 'Fibre végétale résistante' },
  {
    value: 'Corde',
    label: 'Corde',
    description: 'Corde naturelle ou synthétique',
  },
...
export function MaterialSelector({
  ...
  const selectedMaterial = PREDEFINED_MATERIALS.find(

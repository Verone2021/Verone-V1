        ...
        <div className="flex-1 overflow-y-auto">
          {showCancelConfirm ? (
            <div className="space-y-4">
              <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                ...
                <p className="text-sm text-orange-700 mb-4">
                  Vous allez annuler{' '}
                  <strong>{quantityRemaining} unite(s)</strong> restante(s).
                  Cette action supprimera ces unites du stock previsionnel.
                </p>
                <div>
            ...
            <div className="space-y-6">
              ...
              {/* Actions */}
              <div className="flex flex-col gap-2 pt-4 border-t md:flex-row md:justify-between">
                {/* Bouton annuler reliquat */}
                <div>
                  {quantityRemaining > 0 && (
                    <ButtonV2
                      variant="outline"
                ...
                <div className="flex flex-col gap-2 md:flex-row">
                  ...
                  {quantityRemaining > 0 && (
                    <ButtonV2
                      ...
                      className="bg-verone-success hover:bg-verone-success/90 w-full md:w-auto"
                    >
                      {validating
                        ? 'Validation...'
                        : willBeComplete

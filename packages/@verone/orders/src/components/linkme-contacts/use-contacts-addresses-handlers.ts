...
/**
 * use-contacts-addresses-handlers — Hook centralisant tous les handlers
 * (useCallback) pour les 4 sections billing/delivery contact/address.
 *
 * @module use-contacts-addresses-handlers
 */

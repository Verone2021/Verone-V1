...
const roleConfigs: Record<UserRole, RoleConfig> = {
  ...
  catalog_manager: {
    ...
    description:
      'Sourcing produit, descriptions, photos. Pas accès aux prix de vente, ni à la finance.',
    color: 'green',
    icon: <Package className="h-3 w-3" />,
    permissions: [
      'Création fiches sourcing + import via plugin Chrome',
      'Édition descriptions, photos, dimensions, poids',
      'Saisie prix d’achat indicatif (base_price_ht)',
      'Création de variantes produit',
      'Création de fournisseurs',
      'Consultation stock (lecture seule)',
      'Consultation publication canaux (badges, lecture seule)',
    ],

...
import { ContactFormModalWrapper as ContactFormModal } from '@verone/organisations/components/modals/ContactFormModalWrapper';
    ...
    return (
      ...
      >
        <p style={{ color: colors.text.subtle, fontSize: '0.875rem' }}>
          💡 Les contacts pourront être ajoutés après la création de
          l'organisation
        </p>
      </div>
    );

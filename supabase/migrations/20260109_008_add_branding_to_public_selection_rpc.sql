-- ============================================================================
-- MIGRATION: Add affiliate branding colors to public selection RPCs
-- Date: 2026-01-09
-- Description: Include affiliate colors in RPC response for dynamic styling
-- ============================================================================
...
BEGIN
  -- Recuperer la selection et l'affilié
...
DECLARE
  ...
  v_linkme_channel_id UUID := '93c68db1-5a30-4168-89ec-6383152be405';
BEGIN
  -- Recuperer la selection par slug avec branding affilié
  SELECT ls.*, la.id as affiliate_id,
         la.primary_color, la.secondary_color, la.accent_color,
         la.text_color, la.background_color, la.logo_url
  INTO v_selection
...
DO $$
BEGIN
  RAISE NOTICE '✅ RPCs updated: now include affiliate branding colors';
  RAISE NOTICE '   - primary_color (default: #5DBEBB)';
  RAISE NOTICE '   - secondary_color (default: #3976BB)';
  RAISE NOTICE '   - accent_color (default: #7E84C0)';
  RAISE NOTICE '   - text_color (default: #183559)';
  RAISE NOTICE '   - background_color (default: #FFFFFF)';
  RAISE NOTICE '   - logo_url';
END $$;

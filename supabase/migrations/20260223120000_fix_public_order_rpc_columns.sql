-- ============================================================================
-- Migration: Fix create_public_linkme_order RPC
-- Date: 2026-02-23
-- Bug: owner_contact_id and billing_contact_id columns do NOT exist in
--      sales_order_linkme_details. Store them in sales_orders instead.
-- Also: Drop obsolete 7-param version (oid 159236, no longer called).
-- ============================================================================

-- 1. Drop obsolete 7-param version
DROP FUNCTION IF EXISTS public.create_public_linkme_order(uuid, uuid, jsonb, jsonb, jsonb, jsonb, jsonb);

-- 2. Replace 8-param version with fixed column mapping
...
BEGIN
  ...
  -- =========================================
  -- 9. CREATE SALES_ORDER
  -- FIX: Store contact IDs here (columns exist in sales_orders)
  -- =========================================
  ...
  -- FIX: Removed owner_contact_id and billing_contact_id
  --      (these columns do NOT exist in this table)
  -- =========================================

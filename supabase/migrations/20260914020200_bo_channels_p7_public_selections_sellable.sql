-- =====================================================================
-- [BO-CHANNELS-P7-001] Règle « vendable » — sélections publiques LinkMe (/s/…)
-- =====================================================================
-- get_public_selection(uuid) et get_public_selection_by_slug(text), appelées par
-- apps/linkme/src/app/(public)/s/[id]/use-selection-layout.ts:128. Elles ne
-- filtraient aucun statut produit : un produit retiré, arrêté ou en brouillon
-- restait visible dans la sélection partagée. Ajout de product_is_sellable dans
-- le filtre des éléments ; tout le reste (masquage staff, canal actif, marque,
-- magasins) est identique aux versions en production du 14/09.
-- Effet mesuré le 14/09 : Pokawa 42 → 36 (6 produits retirés ou brouillon),
-- Black & White Burger 2 → 2.
...
-- RETOUR ARRIÈRE : ré-exécuter les définitions du 14/09 (sans filtre produit),

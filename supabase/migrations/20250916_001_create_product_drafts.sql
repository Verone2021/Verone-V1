...
CREATE TABLE IF NOT EXISTS product_drafts (
  ...
  supplier_price DECIMAL(10,2), -- Prix d'achat fournisseur (sera mappé vers price_ht)
  selling_price DECIMAL(10,2),  -- Prix de vente Vérone (sera mappé vers cost_price)
...
COMMENT ON COLUMN product_drafts.supplier_price IS 'Prix d''achat fournisseur (sera mappé vers price_ht lors création finale)';
COMMENT ON COLUMN product_drafts.selling_price IS 'Prix de vente Vérone (sera mappé vers cost_price lors création finale)';

-- ============================================================================
-- Migration: Add COALESCE for requester_type in create_public_linkme_order
-- Date: 2026-02-23
-- Bug: Frontend was not sending p_requester.type, causing NOT NULL violation
--      on sales_order_linkme_details.requester_type
-- Fix: COALESCE(p_requester->>'type', 'responsable_enseigne') as safety net
-- ============================================================================
...
BEGIN
  ...
  -- FIX: COALESCE on requester_type to prevent NOT NULL violation
  -- =========================================
  ...
  INSERT INTO sales_order_linkme_details (
    ...
    v_order_id,
    -- Requester (COALESCE as safety net)

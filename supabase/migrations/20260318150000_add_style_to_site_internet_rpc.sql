-- Add p.style to get_site_internet_products() RPC
-- Required for sidebar filters (style filter)
...
RETURNS TABLE (
  ...
  style TEXT  -- NEW: product style for sidebar filters
)
LANGUAGE plpgsql
SECURITY DEFINER

-- Migration: Étendre RPC site_internet avec 11 nouveaux champs produit
-- Date: 2025-11-17
-- Description: Ajouter description, brand, selling_points (avec waterfall) + dimensions, weight, suitable_rooms, subcategory (READ-ONLY)

-- =============================================================================
-- 1. DROP ET RECRÉER get_site_internet_products() avec nouveaux champs
-- =============================================================================
...
RETURNS TABLE (
  ...
  -- Éditables avec waterfall canal → produit
  description TEXT,
  technical_description TEXT,
  brand TEXT,
  selling_points TEXT[],

  -- READ-ONLY (catalogue uniquement)
  dimensions JSONB,
  weight NUMERIC,
  suitable_rooms TEXT[],
  subcategory_id UUID,

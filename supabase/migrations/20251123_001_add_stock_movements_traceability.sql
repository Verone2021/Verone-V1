-- =====================================================
-- MIGRATION : Ajout Traçabilité Stock Movements
-- Date: 2025-11-23
-- Priority: P1 - TRAÇABILITÉ MANQUANTE
-- =====================================================
-- RAISON : Créer automatiquement mouvements stock lors réception/expédition
-- IMPACT : Historique complet des mouvements physiques de stock
-- =====================================================

-- =============================================================================
-- MODIFIER : update_stock_on_reception() - Ajouter création stock_movement
-- =============================================================================
...
BEGIN
    ...
    -- ✅ NOUVEAU : Créer mouvement stock (TRAÇABILITÉ)
...
-- =============================================================================
-- MODIFIER : update_stock_on_shipment() - Ajouter création stock_movement
-- =============================================================================
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '═══════════════════════════════════════════════════════';
    RAISE NOTICE '🎉 MIGRATION 20251123_001: TRAÇABILITÉ STOCK COMPLÉTÉE';
    RAISE NOTICE '═══════════════════════════════════════════════════════';
    RAISE NOTICE '';
    RAISE NOTICE '✅ Fonctions modifiées :';
    RAISE NOTICE '   - update_stock_on_reception() → Crée stock_movement IN';
    RAISE NOTICE '   - update_stock_on_shipment() → Crée stock_movement OUT';
    RAISE NOTICE '';
    RAISE NOTICE '📊 Impact :';
    RAISE NOTICE '   - Historique complet mouvements physiques stock';
    RAISE NOTICE '   - Traçabilité qui/quand/combien pour chaque mouvement';
    RAISE NOTICE '   - Table stock_movements alimentée automatiquement';
    RAISE NOTICE '';
    RAISE NOTICE '═══════════════════════════════════════════════════════';
END $$;

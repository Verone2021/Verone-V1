-- =====================================================
-- MIGRATION: Ajouter justification_optional à v_expenses_with_details
-- Date: 2026-01-05
-- Description: Aligne la colonne "À compléter" entre Transactions et Catégorisation
-- =====================================================
...
SELECT
  ...
  bt.amount_vat,
  bt.vat_source,
  -- Justification optional (NEW - aligne avec Transactions)

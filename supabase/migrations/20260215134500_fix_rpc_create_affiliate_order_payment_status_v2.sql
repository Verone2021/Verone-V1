-- ============================================
-- Fix: Rename payment_status → payment_status_v2 in create_affiliate_order RPC
--
-- The column was renamed but the RPC still referenced the old name,
-- causing: 'column "payment_status" of relation "sales_orders" does not exist'
-- ============================================

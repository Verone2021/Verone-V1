-- Add color (from variant_attributes) to get_site_internet_products() RPC
-- Required for color filter pastilles in catalogue sidebar
...
RETURNS TABLE (
  ...
  style TEXT,
  color TEXT  -- NEW: from variant_attributes->>'color' or ->>'couleur'
)

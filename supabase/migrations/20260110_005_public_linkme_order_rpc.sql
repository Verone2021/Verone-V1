-- ============================================================================
-- Migration: RPC pour commandes publiques LinkMe
-- Date: 2026-01-10
-- Description: Permet aux clients anonymes de créer des commandes via LinkMe
--              en utilisant SECURITY DEFINER pour bypasser RLS
-- ============================================================================

-- ============================================
-- FONCTION PRINCIPALE: create_public_linkme_order
-- ============================================

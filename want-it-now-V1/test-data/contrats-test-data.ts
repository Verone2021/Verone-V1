...
export const TEST_PROPRIETES: TestPropriete[] = [
...
export const TEST_UNITES: TestUnite[] = [
...
export const TEST_PROPRIETAIRES: TestProprietaire[] = [
...
export const TEST_CONTRAT_SCENARIOS = {
...
export const TEST_PERFORMANCE_DATA = {
...
export const TEST_HELPERS = {
  ...
  generateRandomContractData: (overrides: any = {}) => ({
    ...TEST_CONTRAT_SCENARIOS.villa_nice_fixe,
    ...overrides,
  ...
  validateContractStructure: (data: any) => {

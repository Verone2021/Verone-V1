-- Script: Création RPCs Google Merchant (directe via psql)
-- Date: 2025-11-06
-- Objectif: Créer fonctions RPC get_google_merchant_products() et get_google_merchant_stats()

-- =====================================================
-- RPC 1: get_google_merchant_stats()
-- =====================================================
...
-- =====================================================
-- RPC 2: get_google_merchant_products()
-- =====================================================
...
-- Vérification
SELECT 'RPCs créées avec succès!' AS status;

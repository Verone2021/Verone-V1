...
# ==============================================================================
# 5) Move scripts to project scripts area
# ==============================================================================
if [ -d ".claude/scripts" ] && [ "$(ls -A .claude/scripts 2>/dev/null)" ]; then
  echo "  → Moving .claude/scripts/* to scripts/claude/"
  for f in .claude/scripts/*; do
    [ -f "$f" ] && git mv "$f" "scripts/claude/" || true
  done
fi
...
# ==============================================================================
for dir in .claude/scripts .claude/plans .claude/memories; do

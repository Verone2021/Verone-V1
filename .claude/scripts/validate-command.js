...
const SECURITY_RULES = {
  ...
  DANGEROUS_PATTERNS: [
    ...
    // Database destructive commands (Supabase/PostgreSQL specific)
    /DROP\s+TABLE/i,
    /DROP\s+DATABASE/i,
    /TRUNCATE\s+/i,
  ...
  // Safe paths where rm -rf is allowed - Vérone specific
  SAFE_RM_PATHS: [
...
class CommandValidator {
  constructor() {
    this.logFile = "/Users/romeodossantos/verone-back-office-V1/.claude/logs/security.log";
  }

...
| Agent MCP | Rôle Principal | Usage Optimal | Integration |
|-----------|----------------|---------------|-------------|
| **🧠 Serena** | Code Intelligence | TOUJOURS en premier | Core Analysis |
| **🗄️ Supabase** | Database Operations | Validation DB continue | Data Layer |
| **📚 Context7** | Documentation Officielle | Avant nouvelle implémentation | Knowledge Base |
| **🐙 GitHub** | Repository Management | PRs + branches automatiques | Version Control |
| **🚀 Vercel** | Deployment | CI/CD intégré | Production |
| **💭 Sequential** | Architecture Complexe | Planning > 3 étapes | Strategy |
| **🎭 Playwright** | Browser Testing | Console error checking | Quality |
...
### 🎯 Feature Development (Mode Pro)

```typescript
// Phase 1: PLAN-FIRST (Sequential Thinking Mandatory)
mcp__sequential-thinking__sequentialthinking({
  thought: "Analyser la nouvelle fonctionnalité",
  totalThoughts: 7,
...
mcp__sequential-thinking__sequentialthinking({
  thought: "Analyser l'erreur système",
...
### 🧪 Testing Strategy (Post 677-Tests Era)

```typescript
// NOUVEAU: Tests Ciblés Intelligents (vs 677 exhaustifs)
...
// 2. Console Error Checking (Playwright) - PRIORITÉ 1
mcp__playwright__browser_console_messages()
// Zero tolerance: 1 erreur = échec système

// 3. Database Validation (Supabase) - PRIORITÉ 2
...
| Commande | MCPs Utilisés | Durée | Output |
|----------|---------------|-------|--------|
| `/test-app-complete` | Serena + Supabase + Sequential | 2min | Score/100 |
| `/console-check` | Playwright + Supabase + Serena | 30s | ✅/❌ |
...
### Après Orchestration MCP
- ✅ Tests automatisés: 2min
- ✅ Zero console errors policy
- ✅ Déploiements sécurisés
- ✅ **+300% efficacité développement**
...
**Révolution 2025** : De développement manuel vers orchestration IA complète !
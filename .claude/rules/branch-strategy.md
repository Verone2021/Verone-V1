...
- `.claude/rules/no-worktree-solo.md` — Workflow solo, JAMAIS `git worktree add`. Bascule entre branches via `git checkout` (avec `git stash` si dirty).
...
- `.claude/DECISIONS.md` (ADR-022 — incident bundling Canaux de Vente, ADR-023 ANNULÉE 2026-05-02)
